...
async function main() {
  ...
  const contract = await ethers.getContractFactory("ReinsuranceContract"); // Specify here your contract name
  //const contract = await ethers.getContractFactory("ParametricInsuranceContract"); // Specify here your contract name
  //const contract = await ethers.getContractFactory("RiskPoolingContract"); // Specify here your contract name
